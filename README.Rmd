...
They are composed of a set of responses in one or more psychometric tests (e.g. 10, 20, 30 items) in Likert scale (e.g. 3, 4, 5, 7).<br />
...
If no data is uploaded, `EFAshiny` will use the [Rosenberg Self-Esteem Scale ]("https://www.dropbox.com/s/hpksg1zev5021z1/RSE.zip?dl=0") dataset to perform the default demostrations.
